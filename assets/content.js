  ...
  var pages = [
    ...
    },
    {
      ...
      body: md(
        ...
        "| 10.6 | **[Function values on the Pyro VM](#/lambdas)** — shipped: `PUSHFN`/`CALL_VALUE` opcodes, a `kFunc`/`VAL_FUNC` value kind in both VMs, and a C function-pointer table in the AOT. Named functions and **non-capturing** lambdas are first-class on pyro; true closures still need go/node | 🚧 |",
    ...
    },
    {
      ...
      body: md(
        ...
        "| `example_funcvalues.cryo` | **[function values](#/lambdas)** on the VM — pass/store/return functions, non-capturing lambdas | pyro/go/node |",
