...
(function () {
  ...
  var pages = [
    ...
    },
    {
      ...
      lead: "Every example shipped under `cryo/examples/`, with the backend each one targets.",
      body: md(
        "## Every shipped example",
        "",
        "All of these live under `cryo/examples/`:",
        "",
        ...
        "| `example_slices.cryo` | **slices & ranges as values** — `xs[a..b]`, `s[a..]`, `int[] r = 0..5`, `sum(0..5)` | pyro/go/node |",
        "| `frontend/app.cryo` | **a web page in Cryo** — html/javascript/CSS blocks composed by name; builds to one vanilla file or to `.html` + `app.wasm` | `--backend frontend` |",
        "| `api/server.cryo` | **a REST API in Cryo** — struct + json_encode payloads, validation rules and stats; compiles to a standalone `.exe` that serves on :8080 | `--backend go` |",
        ...
        "```",
        "",
        "> `--backend auto` picks the lightest backend that covers the features a program uses.",
        ""
      )
    },
  ];
  ...
  var groups = [
    ...
    { title: "Examples", pages: ["exemplos", "ex-core", "ex-colecoes", "ex-tipos", "ex-funcoes", "ex-dados", "ex-web", "ex-ia", "ex-foreign", "ex-catalogo"] }
  ];
